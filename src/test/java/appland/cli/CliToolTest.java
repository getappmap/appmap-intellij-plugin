...
public class CliToolTest extends AppMapBaseTest {
    ...
    public void urlsAppMap() {
        assertEquals("https://github.com/applandinc/appmap-js/releases/download/%40appland%2Fappmap-v3.32.2/appmap-linux-x64",
                CliTool.AppMap.getDownloadUrl("3.32.2", "linux", "x64"));

        assertEquals("https://github.com/applandinc/appmap-js/releases/download/%40appland%2Fappmap-v3.32.2/appmap-macos-arm64",
    ...
    public void urlsScanner() {
        assertEquals("https://github.com/applandinc/appmap-js/releases/download/%40appland%2Fscanner-v1.67.0/scanner-linux-x64",
                CliTool.Scanner.getDownloadUrl("1.67.0", "linux", "x64"));

        assertEquals("https://github.com/applandinc/appmap-js/releases/download/%40appland%2Fscanner-v1.67.0/scanner-macos-arm64",
