...
public class CodeObjectsPanel extends JPanel implements Disposable, DataProvider {
    private final Tree tree;
    private final Project project;

    public CodeObjectsPanel(@NotNull Project project, @NotNull Disposable parent) {
    ...
    private static @NotNull Tree setupTree(@NotNull Project project, @NotNull Disposable parent) {
        var tree = new Tree(new AsyncTreeModel(new CodeObjectsModel(project, parent), parent));
