 ...
 */
public class OldAppMapFileEditor extends UserDataHolderBase implements FileEditor {
    ...
    public OldAppMapFileEditor(@NotNull Project project, @NotNull VirtualFile file) {
        ...
        file.getFileSystem().addVirtualFileListener(new VirtualFileListener() {
            ...
            public void contentsChanged(@NotNull VirtualFileEvent event) {
                ...
                if (isSelected.get()) {
                    ...
                    ApplicationManager.getApplication().invokeLater(OldAppMapFileEditor.this::loadAppmapData, ModalityState.defaultModalityState());
                } else {
