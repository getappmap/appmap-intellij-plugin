...
export function mountWebview() {
  ...
  messages.on('init', ({apiKey}) => new Vue({
    el: '#app', render(h) {
      return h(VChat, {
        ref: 'chat', props: {
          apiKey,
          ...
          suggestions: [{
            ...
            prompt: 'Ask me how to install AppMap in your development environment for a detailed guide.',
          }, {
            ...
            prompt: 'Inquire about integrating AppMap into your existing projects for successful implementation.',
          }, {
            title: 'Solving AppMap Installation Issues',
            subTitle: 'Overcoming Common Challenges',
            prompt: 'Encountering installation issues with AppMap? Ask me for solutions to common problems.',
          }, {
            title: 'Enhancing AppMap Performance',
            subTitle: 'Tips for Large-Scale Projects',
            prompt: 'Want to optimize AppMap for large projects? I can provide tips on enhancing its performance.',
          },],
        },
      })
    },
