import { layout } from './chunk-3TO7K2MM.js';
import { Graph } from './chunk-O2SMC75L.js';
import { require_crypto_browserify } from './chunk-SDHD3UEE.js';
import { require_dist, require_dayjs_min, require_dist2, require_purify, getConfig, setAccTitle, getAccTitle, setAccDescription, getAccDescription, setDiagramTitle, getDiagramTitle, log$1, clear, select_default, utils, configureSvgSize, line_default, basis_default, parseGenericTypes } from './chunk-IKWFAN4T.js';
import { init_polyfillShim, __toESM, import_buffer } from './chunk-NBJJPFWB.js';

// node_modules/mermaid/dist/erDiagram-9861fffd.js
init_polyfillShim();

// node_modules/mermaid/node_modules/uuid/dist/esm-node/index.js
init_polyfillShim();
...
function sha1(bytes) {
  if (Array.isArray(bytes)) {
    bytes = import_buffer.Buffer.from(bytes);
  } else if (typeof bytes === "string") {
    bytes = import_buffer.Buffer.from(bytes, "utf8");
  }
...
export { diagram };
//# sourceMappingURL=erDiagram-9861fffd-KBEROXQ7.js.map
//# sourceMappingURL=erDiagram-9861fffd-KBEROXQ7.js.map