...
var loader$m = async () => {
  const { diagram: diagram2 } = await import('./c4Diagram-3d4e48cf-WELUJHW2.js');
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-66a62f08-GD6WSJHD.js');
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import('./flowDiagram-v2-96b9c2cf-WLX6EVUZ.js');
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import('./erDiagram-9861fffd-ZPAZDORV.js');
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import('./gitGraphDiagram-72cf32ee-6DAG7YRN.js');
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import('./ganttDiagram-c361ad54-244WY7VN.js');
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import('./infoDiagram-f8f76790-LRQYQJVL.js');
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import('./pieDiagram-8a3498a8-SYPQJY6W.js');
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import('./quadrantDiagram-120e2f19-WUECDVIM.js');
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import('./xychartDiagram-e933f94c-6KUNB4IL.js');
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import('./requirementDiagram-deff3bca-IZL6FIZJ.js');
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import('./sequenceDiagram-704730f1-OPN2PXDU.js');
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import('./classDiagram-70f12bd4-63K5QWD4.js');
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import('./classDiagram-v2-f2320105-5HEQ33YM.js');
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-587899a1-IFGSTMXA.js');
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import('./stateDiagram-v2-d93cdb3a-76PP5UXO.js');
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import('./journeyDiagram-49397b02-FUWMNL4S.js');
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import('./flowchart-elk-definition-4a651766-MCKECNDN.js');
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import('./timeline-definition-85554ec2-3SCVFTUX.js');
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import('./mindmap-definition-fc14e90a-LYAI5WNS.js');
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import('./sankeyDiagram-04a897e0-6L2YHKMN.js');
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import('./blockDiagram-38ab4fdb-D7SQQHDL.js');
...
//# sourceMappingURL=chunk-YWHJFWTB.js.map
//# sourceMappingURL=chunk-YWHJFWTB.js.map